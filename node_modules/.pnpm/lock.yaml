...
importers:
  ...
  .:
    specifiers:
      '@zi-shui/components': workspace:*
      '@zi-shui/theme-chalk': workspace:*
      '@zi-shui/utils': workspace:*
      sass: ^1.53.0
      typescript: ^4.7.4
      unplugin-vue-define-options: ^0.6.2
      vue: ^3.2.37
    dependencies:
      '@zi-shui/components': link:packages/components
      '@zi-shui/theme-chalk': link:packages/theme-chalk
      '@zi-shui/utils': link:packages/utils
      typescript: 4.7.4
      vue: 3.2.37
    devDependencies:
      sass: 1.53.0
      unplugin-vue-define-options: 0.6.2_vue@3.2.37
